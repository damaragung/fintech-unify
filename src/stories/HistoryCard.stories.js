...
import HistoryCard from '../lib/HistoryCard';
...
storiesOf('History Card', module).add('with container', () => <HistoryCardContainer />);

storiesOf('History Card', module).add('status waiting', () => <HistoryCard status="waiting" />);
storiesOf('History Card', module).add('status success', () => <HistoryCard status="success" />);
storiesOf('History Card', module).add('status failed', () => <HistoryCard status="failed" />);
